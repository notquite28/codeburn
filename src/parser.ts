...
function providerCallToCachedCall(call: ParsedProviderCall): CachedCall {
  return {
    ...
    costUSD: (call.provider === 'omp' || call.provider === 'mistral-vibe' || call.provider === 'antigravity' || call.provider === 'devin' || call.provider === 'vercel-gateway' || call.provider === 'hermes' || call.provider === 'kiro' || call.provider === 'codewhale' || call.provider === 'quickdesk') ? call.costUSD : undefined,
